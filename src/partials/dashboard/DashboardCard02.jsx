      ...
      <div className="px-5 pt-5">
        <header className="flex items-start justify-between mb-2">
          ...
          <EditMenu align="right" className="relative inline-flex">
            <li>
              <Link className="flex px-3 py-1 text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-slate-800 dark:hover:text-slate-200" to="#0">
                Option 1
              </Link>
            </li>
            <li>
        ...
        <h2 className="mb-2 text-lg font-semibold text-slate-800 dark:text-slate-100"> Cashe Music</h2>
